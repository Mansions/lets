...
def make_app():
	return tornado.web.Application([
		...
		(r"/p/verify", redirectHandler.handler, dict(destination="https://osu.themansions.nl/index.php?p=2")),
		(r"/u/(.*)", redirectHandler.handler, dict(destination="https://osu.themansions.nl/index.php?u={}")),
